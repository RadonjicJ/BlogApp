        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form:form role="form" action="change-password" modelAttribute="changePassword">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                ...
                <div class="card-footer">
                  ...
                  <a href="user-edit-profile" type="button" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form:form>
