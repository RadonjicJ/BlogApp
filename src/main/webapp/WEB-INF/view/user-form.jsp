        ...
        <div class="row">
          <div class="col-md-12">
           <div class="card card-primary">
              ...
              <!-- form start -->
              <form:form role="form" action="user-save" modelAttribute="user" enctype="multipart/form-data">
                <div class="row">
                  <!-- left side -->
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <form:errors path="username" cssClass="text-danger" cssStyle="font-size: 80%"/>
	                  </div>
	                  <div class="form-group">
	                    <label>Password</label>
	                    <form:input path="password" type="text" class="form-control" placeholder="Enter password"/>
	                    <form:errors path="password" cssClass="text-danger" cssStyle="font-size: 80%"/>
	                  </div>
	                  <div class="form-group">
	                    <label>Name</label>
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
	                  ...
	                  <div class="form-group">
	                    <label>Roles</label>
	                    <form:select path="authorities" class="select2" multiple="multiple" data-placeholder="Select a Role" style="width: 100%;">
	                  ...
	                  <form:errors path="authorities" cssClass="text-danger" cssStyle="font-size: 80%"/>
	                  <div class="form-check">
	                    <form:checkbox path="enabled" class="form-check-input" id="exampleCheck1"/>
                ...
                <div class="card-footer">
                  ...
                  <a href="user-list" type="button" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form:form>
              <!-- /.form -->
            </div>
