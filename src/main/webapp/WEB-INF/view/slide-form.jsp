  ...
  <div class="content-wrapper" style="min-height: 177px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Slides Form</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
           <div class="card card-primary">
              ...
              <!-- form start -->
              <form:form role="form" action="slide-save" modelAttribute="slide" enctype="multipart/form-data">
                <form:hidden path="id"/>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class=" col-md-6">
                      <label></label>
                      <div class="form-group">
                        <c:if test="${slide.image != null}" >
	                      <img src="../${slide.image}" style="width: 30%;">
	                    </c:if>
	                  </div>
	                </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:errors path="buttonTitle" cssClass="text-danger" cssStyle="font-size: 80%"/>
                  </div>
                  <div class="form-group">
                    <label>Button Url</label>
                    <form:input path="buttonUrl" type="text" class="form-control" placeholder="Enter button url"/>
                    <form:errors path="buttonUrl" cssClass="text-danger" cssStyle="font-size: 80%"/>
                  </div>
                  <div class="form-group">
                    <label>Order</label>
                ...
                <div class="card-footer">
                  ...
                  <a href="slide-list" type="button" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form:form>
