              ...
              <div class="card-header">
			    ...
			    <div class="card-tools">
			      <a href="tag-form" class="btn btn-success"> 
				    <i class="fas fa-plus-square"></i> Add new Tag
				  </a>
			    </div>
			  </div>
              <!-- /.card-header -->
                          ...
                          <c:forEach var="tag" items="${tagList}">
                            <tr role="row" class="odd">
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
                        		  <a href="tag-update-form?id=${tag.id}" type="button" class="btn btn-info">
		                    ...
		                    <div class="modal fade" id="delete-modal-${tag.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-body">
					                <p>Do you want to delete tag : <b>${tag.name}</b></p>
					              </div>
					              <div class="modal-footer justify-content-between">
					                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					                <a href="tag-delete?id=${tag.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
