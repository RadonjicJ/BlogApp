            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group col-sm-2">
              	  <button id="clearFilter" type="button" class="btn btn-block btn-default ">Clear filters</button>
                </div>
              	...
              	<div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input id="categorySearch" type="text" class="form-control" placeholder="Search by category">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label>Author</label>
                        <input id="authorSearch" type="text" class="form-control" placeholder="Search by author">
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label>Important</label>
                        <select  id ="isImportantSearch" class="form-control">
              ...
              <div class="card-header">
			    ...
			    <div class="card-tools">
			      <a href="blog-form" class="btn btn-success"> 
				    <i class="fas fa-plus-square"></i> Add new Blog
				  </a>
			    </div>
			  </div>
              <!-- /.card-header -->
                          ...
                          <c:forEach var="blog" items="${blogList}">
                            <tr role="row" class="odd">
                              <td>
		                        ...
		                        <img src="<c:url value="../${blog.image}"/>" alt="https://placehold.co/600x400">  
		                       <!-- <img src="${blog.image}" alt="https://placehold.co/600x400">  -->
		                      </td>
		                      <td>
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
		                          <c:if test="${blog.isImportant}">
		                            <a href="blog-is-important?id=${blog.id}" type="button" class="btn btn-success">
		                              <i class="fas fa-check"></i>
		                            </a>
		                          </c:if>
		                          <c:if test="${!blog.isImportant}">
		                            <a href="blog-is-important?id=${blog.id}" type="button" class="btn btn-danger">
		                              <i class="fas fa-times"></i>
		                            </a>
		                          </c:if>
                        		  <a href="blog-update-form?id=${blog.id}" type="button" class="btn btn-info">
		                    ...
		                    <div class="modal fade" id="delete-modal-${blog.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-footer justify-content-between">
					                ...
					                <a href="blog-delete?id=${blog.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
  ...
  $(function () {
    ...
    $('#titleSearch').on('keyup', function() {
    	$('#example1')
        	.DataTable()
        	.column(3)
        	.search($('#titleSearch').val(), false, true)
        	.draw();
    });
    ...
    $('#categorySearch').on('keyup', function() {
    	$('#example1')
        	.DataTable()
        	.column(2)
        	.search($('#categorySearch').val(), false, true)
        	.draw();
    });
    ...
    $('#authorSearch').on('keyup', function() {
    	$('#example1')
        	.DataTable()
        	.column(6)
        	.search($('#authorSearch').val(), false, true)
        	.draw();
    });
  
    $('#isImportantSearch').on('change', function() {
        $('#example1')
            .DataTable()
            .column(1)
            .search($('#isImportantSearch').val(), false, true)
            .draw();
    });
