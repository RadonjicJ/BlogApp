              	    ...
              	    <div class="col-sm-12">
                        ...
                        <tbody>
                          <c:forEach var="message" items="${messageList}">
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
		                          <c:if test="${!message.isSeen}">
		                            <a href="message-is-seen?id=${message.id}" type="button" class="btn btn-info">
		                    ...
		                    <div class="modal fade" id="delete-modal-${message.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-body">
					                <p>Do you want to delete message?</p>
					              </div>
					              <div class="modal-footer justify-content-between">
					                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					                <a href="message-delete?id=${message.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
