                          ...
                          <c:forEach var="category" items="${categoryList}">
                            <tr role="row" class="odd">
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
                        		  <a href="category-update-form?id=${category.id}" type="button" class="btn btn-info">
		                    ...
		                    <div class="modal fade" id="delete-modal-${category.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-body">
					                <p>Do you want to delete category : <b>${category.name}</b></p>
					              </div>
					              <div class="modal-footer justify-content-between">
					                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					                <a href="category-delete?id=${category.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
