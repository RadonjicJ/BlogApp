  ...
  <div class="content-wrapper" style="min-height: 177px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">All Blogs Comments</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
              	    ...
              	    <div class="col-sm-12">
                        ...
                        <tbody>
                          <c:forEach var="comment" items="${commentList}">
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
		                          ...
		                          <c:if test="${comment.enabled}">
		                            <a href="comment-enabled?id=${comment.id}" type="button" class="btn btn-success">
		                              <i class="fas fa-eye"></i>
		                            </a>
		                          </c:if>
		                          <c:if test="${!comment.enabled}">
		                            <a href="comment-enabled?id=${comment.id}" type="button" class="btn btn-danger">
		                    ...
		                    <div class="modal fade" id="delete-modal-${comment.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-footer justify-content-between">
					                ...
					                <a href="comment-delete?id=${comment.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
