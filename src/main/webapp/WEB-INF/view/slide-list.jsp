  ...
  <div class="content-wrapper" style="min-height: 177px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Blog Slides</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
			    <h3 class="card-title">All Blog Slides</h3>
			    <div class="card-tools">
			      <a href="slide-form" class="btn btn-success"> 
				    <i class="fas fa-plus-square"></i> Add new Slide
				  </a>
			    </div>
			  </div>
              <!-- /.card-header -->
                        ...
                        <tbody>
                          <c:forEach var="slide" items="${slideList}">
                            <tr role="row" class="odd">
		                      ...
		                      <td>${slide.title}</td>
		                      <td>
		                        <img src="../${slide.image}" alt="https://placehold.co/600x400">
		                      </td>
		                      <td>${slide.buttonTitle}</td>
		                      ...
		                      <td class="text-center">
		                        <div class="btn-group">
		                          ...
		                          <c:if test="${slide.enabled}">
		                            <a href="slide-enabled?id=${slide.id}" type="button" class="btn btn-success">
		                              <i class="fas fa-eye"></i>
		                            </a>
		                          </c:if>
		                          <c:if test="${!slide.enabled}">
		                            <a href="slide-enabled?id=${slide.id}" type="button" class="btn btn-danger">
		                              <i class="fas fa-eye-slash"></i>
		                            </a>
		                          </c:if>
		                          
                        		  <a href="slide-update-form?id=${slide.id}" type="button" class="btn btn-info">
		                    ...
		                    <div class="modal fade" id="delete-modal-${slide.id}" aria-modal="true">
					          <div class="modal-dialog">
					            <div class="modal-content">
					              ...
					              <div class="modal-body">
					                <p>Do you want to delete slide?</p>
					              </div>
					              <div class="modal-footer justify-content-between">
					                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					                <a href="slide-delete?id=${slide.id}" type="button" class="btn btn-primary">Delete</a>
					              </div>
					            </div>
					            <!-- /.modal-content -->
					          </div>
